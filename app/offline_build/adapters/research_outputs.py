"""Adapter: research_outputs table."""
...
class ResearchOutputsAdapter(BaseAdapter):
    ...
    def normalize_record(
        ...
        source_id = first_str(record, "id", "_id", "uuid", "doi")
        ...
        return NormalizedDocument(
            ...
            source_id=source_id,
            title=title,
            url=first_str(record, "url", "link", "pdf_url", "landing_url"),
